...
namespace Filament_Data.Models
{
    ...
    public class SpoolDefinition : Observable
    {
        ...
        //}
        public static SpoolDefinition CreateSpoolDefinition(double spoolDiameter, double minimumDiameter, double spoolWidth, int filamentID, int vendorID,  bool verified = true)
        {
